namespace Abo.Buoyancy
{
    public partial class Fins
    {
        ...
        public decimal WeightKg
        {
            ...
            set
            {
                if (value < 1m || value > 4.4m)
                { throw new Exception("WeightKg must be >=1 and <=4.4"); }
                if (_weightKg != value)
                {
                    _weightKg = value;
                }
        ...
        public decimal VolumeDm3
        {
            ...
            {
                if (value < 1m || value > 4.4m)
                { throw new Exception("VolumeDm3 must be >=1 and <=4.4"); }
                if (_volumeDm3 != value)
                {
                    _volumeDm3 = value;
                }
        ...
        public string Name
        {
            ...
            set
            {
                ...
                { throw new Exception("Name length must be >=1 and <=250"); }
                if (_name != value)
                {
                    _name = value;
                }
